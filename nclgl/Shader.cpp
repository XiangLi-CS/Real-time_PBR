...
{
	glUniformMatrix4fv(glGetUniformLocation(programID, name.c_str()), 1, transposed, val.values);
}

void Shader::SetVector2(const string& name, const Vector2& val)
{
	glUniform2fv(glGetUniformLocation(programID, name.c_str()), 1, (float*)&val);
}

void Shader::SetVector3(const string& name, const Vector3& val)
{
	glUniform3fv(glGetUniformLocation(programID, name.c_str()), 1, (float*)&val);
}

void Shader::SetVector4(const string& name, const Vector4& val)
{
	glUniform4fv(glGetUniformLocation(programID, name.c_str()), 1, (float*)&val);
}
...
void Shader::SetTexture(const std::string& name, const unsigned int& texID, const int& texSlot)
{
	...
	glUniform1i(glGetUniformLocation(programID, name.c_str()), texSlot);
}
